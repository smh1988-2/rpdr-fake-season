...
queens_array = [ {
    ...
    "quote": "I can get jiggy, I can get jiggy and wiggy!"
    },
    {
    "id": 3,
    "name": "Akashia",
    ...
    "quote": "I love the attention, I do. I love it, crave it..."
    },
    {
    "id": 4,
    "name": "Jade",
    ...
    "winner": false,
    "missCongeniality": false,
    "image_url": "https://static.wikia.nocookie.net/logosrupaulsdragrace/images/d/d2/GigiGoode.jpg",
...
while x < queens_array.length
	Queen.create(name: queens_array[x][:name], image: queens_array[x][:image_url])
	x = x + 1
end

episode_challenge = ["Roast of Rupaul", "Rusical" , "Makeover" , "Snatch Game" , "Lipsync Extraganza", "The Coding Ball", "Parody Commericials", "Rumix"]

i = 0
while i < 6
    Episode.create(challenge: episode_challenge.sample)
    i = i + 1
end